---
title: "Untitled Notebook 2025-05-03 13:47:27"
output:
  html_document:
    toc: true
---
...
prepare_named_splits <- function(data, 
                                 ...
                                 seed = 1234) {
  set.seed(seed)
  data[[target]] <- as.factor(as.vector(data[[target]]))
...
prepare_named_splits(original_kaggle_total_data, data_prefix = "original_kaggle_total_data", target = "ordered")

# For new_kaggle_total_data
prepare_named_splits(new_kaggle_total_data, data_prefix = "new_kaggle_total_data", target = "ordered")

# For dropped_device_kaggle_total_data
prepare_named_splits(dropped_device_kaggle_total_data, data_prefix = "dropped_device_kaggle_total_data", target = "ordered")
